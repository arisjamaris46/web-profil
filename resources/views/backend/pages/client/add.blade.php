            ...
            <div class="card-body">
                <form method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3 form-group">
                        ...
                        <input type="text" class="form-control @error('client_name') @enderror" name="client_name" id="client_name" value="{{ old('client_name') }}" autocomplete="off">
                        @error('client_name')
                    ...
                    <div class="mb-3 form-group">
                        ...
                        <input type="text" class="form-control @error('mobile_phone') @enderror" name="mobile_phone" id="mobile_phone" value="{{ old('mobile_phone') }}" autocomplete="off">
                        @error('mobile_phone')
                        <span class="text-danger">{{$message}}</span>
                        @enderror
                    </div>
