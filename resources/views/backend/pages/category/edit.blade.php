...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <a href="{{route('kategori')}}" class="btn btn-sm btn-dark d-sm-inline-block rounded">
            ...
            <div class="card-body">
                <form method="POST" action="{{route('update.kategori',$row->id)}}">
                    ...
                    <div class="mb-3 form-group">
                        ...
                        <input type="text" class="form-control @error('category') @enderror" name="category" id="category" value="{{ old('category',$row->kategori) }}" autocomplete="off">
                        @error('category')
