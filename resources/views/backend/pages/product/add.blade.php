            ...
            <div class="card-body">
                <form method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3 form-group">
                        ...
                        <input type="text" class="form-control @error('product_name') @enderror" name="product_name" id="product_name" value="{{ old('product_name') }}" autocomplete="off">
                        @error('product_name')
                    ...
                    <div class="mb-3 form-group">
                        ...
                        <textarea type="text" class="form-control @error('product_desc') @enderror" name="product_desc" id="product_desc" rows="3">{{ old('product_desc')}}</textarea>
                        @error('product_desc')
                        <span class="text-danger">{{$message}}</span>
                        @enderror
                    </div>
                    <div class="mb-3 form-group">
                        ...
                        <input type="number" class="form-control @error('product_price') @enderror" name="product_price" id="product_price" value="{{ old('product_price') }}" autocomplete="off">
                        @error('product_price')
                        <span class="text-danger">{{$message}}</span>
                        @enderror
                    </div>
